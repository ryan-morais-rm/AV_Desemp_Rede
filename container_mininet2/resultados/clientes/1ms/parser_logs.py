...
log_dir = '/home/ryan-correia/Área de trabalho/projetos/repositorios/github/AV_Desemp_Rede/container_mininet2/resultados/cliente'
...
for fname in os.listdir(log_dir):
    if fname.startswith('log_cliente') and fname.endswith('.txt'):
