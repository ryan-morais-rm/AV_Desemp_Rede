...
log_dir = '/home/ryan-correia/Área de trabalho/projetos/repositorios/github/AV_Desemp_Rede/container_mininet2/resultados/clientes/udp'
...
print(f"\n✅ Parser genérico concluído para UDP! CSVs gerados em: {csv_dir}\n")
