...
log_dir = '/home/ryan-correia/Área de trabalho/projetos/repositorios/github/AV_Desemp_Rede/container_mininet2/resultados/cliente/5ms/udp'
...
for fname in os.listdir(log_dir):
    if fname.startswith('log') and fname.endswith('.txt'):
        ...
        csv_name = fname.replace('.txt', '_dados5ms.csv')
